...
<div class="main-block panned with-footer">
    ...
    <div class="container">
        <h1>@lang('footer.privacypolivy')</h1>

        <div class="row">
            <div class="col-sm-3">
                <a href="" ng-click="scrollTo('infoCo')" id="informationCollection" class="btn btn-block btn-primary">Information Collection</a>
            </div>
            <div class="col-sm-3">
                <a href="" ng-click="scrollTo('infoUs')" id="informationUsage" class="btn btn-block btn-primary">Information Usage</a>
            </div>
            <div class="col-sm-3">
                <a href="" ng-click="scrollTo('infoPro')" id="informationProtection" class="btn btn-block btn-primary">Information Protection</a>
            </div>
            <div class="col-sm-3">
                <a href="" ng-click="scrollTo('coUs')" id="cookieUsage" class="btn btn-block btn-primary">Cookie Usage</a>
            </div>
            <div class="col-sm-3">
                <a href="" ng-click="scrollTo('trDi')" id="thirdPartyDisclosure" class="btn btn-block btn-primary">3rd Party Disclosure</a>
            </div>
            <div class="col-sm-3">
                <a href="" ng-click="scrollTo('trLi')" id="thirdPartyLinks" class="btn btn-block btn-primary">3rd Party Links</a>
            </div>
            <div class="col-sm-3">
                <a href="" ng-click="scrollTo('gooAd')" id="googleAdwords" class="btn btn-block btn-primary">Google AdSense</a>
            </div>
            <div class="col-sm-3">
                <a href="" ng-click="scrollTo('ftcFip')" id="ftcFairInformationPractices" class="btn btn-block btn-primary">Fair Information Practices</a>
            </div>
            <div class="col-sm-3">
                <a href="" ng-click="scrollTo('coppAct')" id="coppaAct" class="btn btn-block btn-primary">COPPA</a>
            </div>
            <div class="col-sm-3">
                <a href="" ng-click="scrollTo('calOppa')" id="caloppaAct" class="btn btn-block btn-primary">CalOPPA</a>
            </div>
            <div class="col-sm-3">
                <a href="" ng-click="scrollTo('canSpam')" id="canspamAct" class="btn btn-block btn-primary">CAN-SPAM</a>
            </div>
            <div class="col-sm-3">
                <a href="" ng-click="scrollTo('ourCon')" id="ourContactInformation" class="btn btn-block btn-primary">Our Contact Information</a>
            </div>
        </div>
        ...
        <span class="anchor-sep" id="infoCo"></span>
        <div class="text-warning"><strong>What personal information do we collect from the people that visit our blog, website or app?</strong></div>
        <br>
        ...
        <br>
        <div class="text-warning"><strong>When do we collect information?</strong></div>
        <br>
        ...
        <span class="anchor-sep" id="infoUs"></span>
        <div class="text-warning"><strong>How do we use your information? </strong></div>
        <br>
        ...
        <span class="anchor-sep" id="infoPro"></span>
        <br>
        <div class="text-warning"><strong>How do we protect visitor information?</strong></div>
        <br>
        ...
        <span class="anchor-sep" id="coUs"></span>
        <br>
        <div class="text-warning"><strong>Do we use 'cookies'?</strong></div>
        <br>
        ...
        <span class="anchor-sep" id="trDi"></span>
        <div class="text-warning"><strong>Third Party Disclosure</strong></div>
        <br>
        ...
        <span class="anchor-sep" id="trLi"></span>
        <br>
        <div class="text-warning"><strong>Third party links</strong></div>
        <br>
        <div class="innerText">We do not include or offer third party products or services on our website.</div>
        <span class="anchor-sep" id="gooAd"></span>
        <div class="text-info"><strong>Google</strong></div>
        <br>
        <div class="innerText">Google's advertising requirements can be summed up by Google's Advertising Principles. They are put in place to provide a positive experience for users. https://support.google.com/adwordspolicy/answer/1316548?hl=en <br><br></div><div class="innerText">We use Google AdSense Advertising on our website.</div><div class="innerText"><br>Google, as a third party vendor, uses cookies to serve ads on our site. Google's use of the DART cookie enables it to serve ads to our users based on their visit to our site and other sites on the Internet. Users may opt out of the use of the DART cookie by visiting the Google ad and content network privacy policy.<br></div>
        ...
        <br>
        <div class="innerText">We along with third-party vendors, such as Google use first-party cookies (such as the Google Analytics cookies) and third-party cookies (such as the DoubleClick cookie) or other third-party identifiers together to compile data regarding user interactions with ad impressions, and other ad service functions as they relate to our website. </div><div class="innerText"><br><i>Opting out:<br>
                Users can set preferences for how Google advertises to you using the Google Ad Settings page. Alternatively, you can opt out by visiting the Network Advertising initiative opt out page or permanently using the Google Analytics Opt Out Browser add on.</i></div>
        <span class="anchor-sep" id="calOppa"></span>
        <br>
        <div class="text-info"><strong>California Online Privacy Protection Act</strong></div>
        <br>
        ...
        <div class="innerText"><br>Users will be notified of any privacy policy changes:</div><div class="innerText">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <strong>•</strong> On our Privacy Policy Page</div><div class="innerText">Users are able to change their personal information:</div><div class="innerText">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <strong>•</strong> By logging in to their account</div>
        <div class="innerText"><br><strong>How does our site handle do not track signals?</strong></div>
        <div class="innerText">We honor do not track signals and do not track, plant cookies, or use advertising when a Do Not Track (DNT) browser mechanism is in place. </div><div class="innerText"><br><strong>Does our site allow third party behavioral tracking?</strong></div>
        <div class="innerText">It's also important to note that we do not allow third party behavioral tracking</div>
        <span class="anchor-sep" id="coppAct"></span>
        <br>
        <div class="text-info"><strong>COPPA (Children Online Privacy Protection Act)</strong></div>
        <br>
        ...
        <span class="anchor-sep" id="ftcFip"></span>
        <br>
        <div class="text-info"><strong>Fair Information Practices</strong></div>
        <br>
        ...
        <div class="innerText"><strong>In order to be in line with Fair Information Practices we will take the following responsive action, should a data breach occur:</strong></div><div class="innerText">We will notify the users via email</div>
        <div class="innerText">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <strong>•</strong> Within 1 business day</div><div class="innerText">We will notify the users via in site notification</div><div class="innerText">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <strong>•</strong> Within 7 business days</div><div class="innerText"><br>We also agree to the individual redress principle, which requires that individuals have a right to pursue legally enforceable rights against data collectors and processors who fail to adhere to the law. This principle requires not only that individuals have enforceable rights against data users, but also that individuals have recourse to courts or a government agency to investigate and/or prosecute non-compliance by data processors.</div>
        <span class="anchor-sep" id="canSpam"></span>
        <br>
        <div class="text-info"><strong>CAN SPAM Act</strong></div>
        <br>
