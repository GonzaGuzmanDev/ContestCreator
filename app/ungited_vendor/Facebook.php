...
class Facebook extends AbstractService
{
    ...
    public function __construct(
        ...
        if (null === $baseApiUri) {
            $this->baseApiUri = new Uri('https://graph.facebook.com/'.Facebook::GRAPH_VERSION.'/');
        }
    }
    ...
    {
        return new Uri('https://www.facebook.com/'.Facebook::GRAPH_VERSION.'/dialog/oauth');
    }
    ...
    {
        return new Uri('https://graph.facebook.com/'.Facebook::GRAPH_VERSION.'/oauth/access_token');
    }
    ...
    public function getDialogUri($dialogPath, array $parameters)
    {
        ...
        $parameters['version'] = Facebook::GRAPH_VERSION;
        $baseUrl = self::WWW_URL . Facebook::GRAPH_VERSION.'/dialog/' . $dialogPath;
