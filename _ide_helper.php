 ...
 * Generated for Laravel 4.2.18 on 2016-01-14.
 *
...
namespace {
    ...
    class Image extends \App\Facades\ImageFacade{
        ...
        public static function convert(){
            return \App\Services\Image::convert();
        }
         ...
         * @static 
         */
        public static function getSizes($path = ''){
            return \App\Services\Image::getSizes($path);
        }
         ...
         * @static 
         */
        public static function resizeAndSave($source, $destination, $width = 100, $height = null, $crop = false, $quality = 90){
            return \App\Services\Image::resizeAndSave($source, $destination, $width, $height, $crop, $quality);
        }
         ...
         * @static 
         */
        public static function recipeAndSave($source, $destination, $recipe){
            return \App\Services\Image::recipeAndSave($source, $destination, $recipe);
        }
         ...
         * @param boolean $crop
         * @param int $quality
         * @return string ImageInterface::THUMBNAIL_INSET:
        ...
        public static function resize($url, $width = 100, $height = null, $crop = false, $quality = 90){
            return \App\Services\Image::resize($url, $width, $height, $crop, $quality);
        }
         ...
         * @static 
         */
        public static function formatConvertAndSave($file_id){
            return \App\Services\Image::formatConvertAndSave($file_id);
        }
