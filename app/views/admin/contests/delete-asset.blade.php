...
@section('modal-title')
    <i class="fa fa-trash"></i> @lang('contest.deleteAsset')
@endsection
@section('modal-content')
        <p>@lang('contest.sureDeleteAsset')</p>
        <div ng-if="asset.preview" class="asset-preview" ng-bind-html="asset.preview"></div>
@endsection
